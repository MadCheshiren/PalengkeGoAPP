...
void main() {
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: ResponsiveWrapper(
          child: const SizedBox(key: Key('subject'), width: double.infinity),
        ),
      ),
    );
  }

  testWidgets('mobile 360dp fills the width, no forced minimum', (tester) async {
  ...
  testWidgets('mobile 390dp fills the width, no forced minimum', (tester) async {
  ...
  testWidgets('mobile 430dp fills the width, no forced minimum', (tester) async {
